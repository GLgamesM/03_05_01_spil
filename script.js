...
function randHint() {
    ...
    if (a == 1) {questionArray.splice(questionArray.indexOf(1), 1);}
    if (a == 2) {questionArray.splice(questionArray.indexOf(2), 1);}
    if (a == 3) {questionArray.splice(questionArray.indexOf(3), 1);}
    if (a == 4) {questionArray.splice(questionArray.indexOf(4), 1);}
    if (a == 5) {questionArray.splice(questionArray.indexOf(5), 1);}
    if (a == 6) {questionArray.splice(questionArray.indexOf(6), 1);}
